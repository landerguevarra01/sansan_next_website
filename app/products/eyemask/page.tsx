      ...
      <div className="px-4 lg:px-20">
        ...
        >
          <div className="flex gap-4 w-max">
            {[
              "/Assets/amazon/eyemask/24K-Eye-Mask-IMG_2 1.png",
              "/Assets/amazon/eyemask/24K-Eye-Mask-IMG_3 2.png",
              "/Assets/amazon/eyemask/24K-Eye-Mask-IMG_4 1.png",
              "/Assets/amazon/eyemask/24K-Eye-Mask-IMG_5 1.png",
              "/Assets/amazon/eyemask/24K-Eye-Mask-IMG_6 1.png",
              "/Assets/amazon/eyemask/24K-Eye-Mask-IMG_7 1.png",
              "/Assets/amazon/eyemask/24K-Eye-Mask-IMG_8 1.png",
              "/Assets/amazon/eyemask/24K-Eye-Mask-IMG_9 1.png",
            ].map((img, index) => (
              <div
                key={index}
