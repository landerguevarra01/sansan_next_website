...
export default function Repelant() {
      ...
      <div className="px-4 lg:px-20">
        ...
        >
          <div className="flex gap-4 w-max">
            {[
              "/Assets/amazon/repelant/MEDELLA-NATURALS-Image-1.png",
              "/Assets/amazon/repelant/MEDELLA-NATURALS-Image-2.png",
              "/Assets/amazon/repelant/MEDELLA-NATURALS-Image-3.png",
              "/Assets/amazon/repelant/MEDELLA-NATURALS-Image-5.png",
              "/Assets/amazon/repelant/MEDELLA-NATURALS-Image-6.png",
              "/Assets/amazon/repelant/MEDELLA-NATURALS-Image-7.png",
            ].map((img, index) => (
              <div
                key={index}
