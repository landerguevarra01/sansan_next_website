      ...
      <div className="px-4 lg:px-20">
        ...
        <div className="my-12 overflow-x-auto whitespace-nowrap">
          <div className="flex flex-col w-max">
            {[
              "/Assets/amazon/chai/BLC-Traditional-Masala-Chai-Panel-1 3.png",
              "/Assets/amazon/chai/BLC-Traditional-Masala-Chai-Panel-2 2.png",
              "/Assets/amazon/chai/BLC-Traditional-Masala-Chai-Panel-3 2.png",
              "/Assets/amazon/chai/BLC-Traditional-Masala-Chai-Panel-4 2.png",
              "/Assets/amazon/chai/BLC-Traditional-Masala-Chai-Panel-5 2.png",
              "/Assets/amazon/chai/BLC-Traditional-Masala-Chai-Panel-6 2.png",
            ].map((img, index, array) => {
